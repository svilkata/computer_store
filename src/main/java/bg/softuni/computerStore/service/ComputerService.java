...
import bg.softuni.computerStore.repository.ComputerRepository;
import org.springframework.stereotype.Service;

import java.math.BigDecimal;

@Service
public class ComputerService implements InitializableService {
    ...
    public void init() {
        if (computerRepository.count() == 0) {
            ...
            initOneComputer("Gigabyte Brix BRI5-10210E", 1550, 1650,
    ...
    private void initOneComputer(String name, double buyAt, double sellAt, String processor,
        ...
        ComputerEntity toAdd = new ComputerEntity()
                .setName(name)
        ...
        this.computerRepository.save(toAdd);
    }
}
