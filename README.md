...
* Функционалност за смяна кой служител да е единствения ADMIN - при успешна смяна на admin, то системата се logout-ва автоматично
...
* при успешна смяна, то системата се logout-ва автоматично, и е нужно нов login
...
* Добавянето, изтриване и промяна количества на Item-s в кошницата чрез Rest и FETCH Api (jQuery and JS)
